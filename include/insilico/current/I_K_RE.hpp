...
#ifndef INCLUDED_I_K_RE_HPP
#define INCLUDED_I_K_RE_HPP
...
class I_K_RE {
 ...
 public:
  static void current(state_type &variables, state_type &dxdt, const double t, unsigned index) {
    ...
    unsigned n_index = engine::neuron_index(index, "n_K_RE");
    ...
    double beta_n = 0.5*exp((10.0 - vt)/40.0);
    ...
    dxdt[n_index] = (n_inf - n)/tau_n;
                                                            ...
                                                            // Current
    engine::neuron_value(index,"I_K_RE",(-1*(gk * pow(n,4) * (v - ek))));
