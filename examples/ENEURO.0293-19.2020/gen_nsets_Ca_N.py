...
for c1 in calciumshift1:
	for c2 in calciumshift2:
		for c in ['0.00024']:
			for l in xrange(0,len(gkleak_array2)):

				for t in xrange(0,len(t_array1)):

					for g in xrange(0,len(gh_array1)):

						NSETS_CONF="/storage/rohan/ISF_Files/RE/nsets_network_mAch_Ca"+c+"_gh"+gh_array2[g]+"_leak"+gkleak_array2[l]+"_tepsp10_calciumshift1"+c1+"_calciumshift2"+c2+"_RE.isf"
						strtofile = ""
